...
def split_windows_args(command: str) -> List[str]:
    # Fast path: If there are no quotes, standard whitespace splitting is 100% accurate
    # and significantly faster because Windows commands do not use backslashes to escape spaces.
    if '"' not in command:
